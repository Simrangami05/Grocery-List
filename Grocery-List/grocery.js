...
const clear = document.querySelector(".buttn");
...
function createItem(value) {
  ...
  parent.classList.add("grocery-store");

  parent.innerHTML = `<h4 class="grocery-item__title">${value}</h4>
    <a href="#" class="grocery-item__link">
    <img src="icons8-trash-can-25.png" alt="">
    </a>`;
...
function removeItems() {
  ...
  let items = document.querySelectorAll(".grocery-store");
